...
Step 2: If no callback → test time-based (open port = fast, closed = slow/reset):
        ...
        http://REDACTED_INTERNAL_IP:22   (likely open → fast)
        http://REDACTED_INTERNAL_IP:9999 (likely closed → slow/timeout)
...
```
REDACTED_INTERNAL_IP/8
REDACTED_INTERNAL_IP/12
REDACTED_INTERNAL_IP/16
fc00::/7  ← IPv6 private
```
