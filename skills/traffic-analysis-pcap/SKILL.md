...
```
ip.addr == REDACTED_INTERNAL_IP                  # source or destination
ip.src == REDACTED_INTERNAL_IP                   # source only
ip.dst == REDACTED_INTERNAL_IP                   # destination only
ip.addr == REDACTED_INTERNAL_IP/24              # subnet
!(ip.addr == REDACTED_INTERNAL_IP)              # exclude host
```
