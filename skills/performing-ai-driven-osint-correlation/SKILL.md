...
- Access to an LLM API (OpenAI, the AI vendor, or local model via Ollama)
...
| LLM API (GPT-4, the AI agent, Ollama) | Cross-source reasoning, pattern detection, and confidence scoring |
